...
const ProductItem = () => {
 ...
 const context = useContext(MyContext);
  ...
  console.log("ProductItem context:", context); // Debug log
  ...
  const handleZoomClick = () => {
    console.log("Zoom button clicked - before setting state");
    console.log("Current context state:", context.openProductDetailModel);
    
    // Try both approaches
    context.setOpenProductDetailMode(true);
  };
      ...
      <div className=" group imagewrapper w-[100%] h-[220px] overflow-hidden rounded-md relative">
        ...
        <div className="action absolute top-[-200px] right-[9px] z-50 flex flex-col items-center gap-2 group-hover:top-[9px] transition-all duration-600">
          ...
          <Button    className="!w-[35px] !h-[35px] !min-w-[35px] !rounded-full !bg-white text-black hover:!bg-orange-500 hover:text-white group">
            <MdZoomOutMap onClick={handleZoomClick}  className="!text-black !text-[18px] group-hover:text-white hover:!text-white" />
          </Button>
           </Tooltip>
